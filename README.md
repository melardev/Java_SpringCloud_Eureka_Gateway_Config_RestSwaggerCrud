...
# Introduction
Micro-service application with Eureka, Gateway, Config Server, and Rest Crud with Swagger. 
Start first the Config Server, then Eureka, then the others, then perform CRUD requests like the dozens
of similar applications I published on my Github.(GET /api/todos, etc.)
